...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  solid: "bg-accent text-ink font-medium hover:bg-cyan-300",
  outline:
    "border border-line bg-white/[0.02] text-slate-200 hover:border-slate-400 hover:bg-white/[0.05]",
  violet:
...
export function Button({
  ...
  return (
    <button
      className={cn(
        "inline-flex items-center justify-center rounded-md font-mono uppercase tracking-wide transition-all duration-200",
